...
class RecyclerAdapter(movieRecyclerActivity: MovieRecyclerActivity) : RecyclerView.Adapter<RecyclerAdapter.ViewHolder>(){
    ...
    var context: Context
    init {
        this.context = movieRecyclerActivity
    }
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        init {
            ...
            movieYear = itemView.findViewById(R.id.yearView)
            itemView.setOnClickListener{ v: View ->
                var position: Int = getAdapterPosition()

                Snackbar.make(v, "Click detecked on item $position", Snackbar.LENGTH_LONG).setAction("Action", null).show()
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ViewHolder {
        val v = LayoutInflater.from(viewGroup.context).inflate(R.layout.movie_layout, viewGroup, false)
        return ViewHolder(v)
    }//end of onCreateViewHolder

    override fun onBindViewHolder(viewHolder: ViewHolder, i: Int) {
        viewHolder.movieTitle.text = movieTitles[i]
        viewHolder.movieYear.text = movieYears[i]
